...
VISUALIZER_STATE_FILE = (
    CONFIG_DIR / "visualizer_state"
)  # recording|paused|processing|error|success
...
MODEL_CACHE_DIR = XDG_CACHE_HOME / "hyprwhspr" / "models"
MODEL_SERVER_PID_FILE = DATA_DIR / "model-server.pid"
MODEL_SERVER_LOG_FILE = DATA_DIR / "model-server.log"

# Long-form recording mode
LONGFORM_STATE_FILE = (
    CONFIG_DIR / "longform_state"
